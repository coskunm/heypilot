  ...
  return (
    <div className={`slide-enter-${direction} h-full flex flex-col items-center justify-center text-center space-y-8`}>
      ...
      <div className="relative mb-8 z-10">
        ...
        <div className="relative bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-xl rounded-full p-8 border border-white/30 shadow-2xl animate-scale-in">
          <div className="relative">
            <Zap className="w-20 h-20 text-white animate-pulse-heartbeat" />
            <Sparkles className="w-8 h-8 text-cyan-300 absolute -top-3 -right-3 animate-sparkle" />
            <Sparkles className="w-6 h-6 text-indigo-300 absolute -bottom-2 -left-2 animate-sparkle" style={{ animationDelay: '1s' }} />
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6 z-10">
        <h1 className="text-4xl md:text-6xl font-light text-white/90 animate-fade-in-words">
        ...
        <h2 className="text-6xl md:text-8xl font-black bg-gradient-to-r from-white via-sky-100 to-cyan-100 bg-clip-text text-transparent animate-fade-in-delay-2">
          HeyPilot AI
        </h2>
      </div>

      {/* Core Qualities */}
      <div className="flex items-center gap-8 text-2xl md:text-3xl font-semibold text-white/80 animate-fade-in-delay-3">
      ...
      <div className="relative max-w-3xl mx-auto animate-fade-in-delay-4">
